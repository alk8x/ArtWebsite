      ...
      <div className="shop-grid">
        <div className="art-card">
          <div className="art-image">
            ...
            <img src={art1} alt="Artwork title" className="art-img" />
          </div>
          <h3>Clementines, oil paint</h3>
          <span className="dimension">Print: 8x10" Original: 5x7"<br /></span>
          <span className="price">Print: $20.00 Original: $150</span>
        </div>

        <div className="art-card">
          <div className="art-image">
            <img src={fanFavorite} alt="Fan favorite" className="fan-favorite-badge" />
            <img src={art2} alt="Artwork title" className="art-img" />
          </div>
        ...
        <div className="art-card">
          <div className="art-image">
            <img src={fanFavorite} alt="Fan favorite" className="fan-favorite-badge" />
            <img src={art3} alt="Artwork title" className="art-img" />
          </div>
        ...
        <div className="art-card">
          <div className="art-image">
            <img src={art4} alt="Artwork title" className="art-img" />
          </div>
